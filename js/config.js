window.MakeEyecatchConfig = {
  ...
  baseStyleRules: {
    ...
    simple70s: {
      label: "静かな紙の記録",
      look: "quiet editorial illustration on textured paper, gentle handmade forms, restrained visual language, minimal detail",
      composition: "one dominant subject with generous negative space and a calm, unhurried layout",
      texture: "washi-like paper grain, dry ink, subtle print irregularity",
      color: "warm off-white, muted charcoal, pale moss and one small warm accent",
      mood: "reflective, intimate, calm and thoughtful",
      negative: "no photorealism, no glossy 3D rendering, no anime style, no excessive detail, no multiple subjects",
    },
    original: {
      label: "シャープなエディトリアル",
      look: "sharp contemporary editorial art direction, refined geometric forms, one decisive visual gesture, premium magazine clarity",
      composition: "one dominant subject, bold crop, disciplined negative space, precise grid-like balance",
      texture: "matte print finish, extremely subtle grain, clean edges",
      color: "white, near-black and one deep indigo accent, controlled high contrast",
      mood: "intelligent, crisp, modern and confident",
    ...
    retro80s: {
      label: "鮮やかなポスター",
      look: "bold graphic poster illustration, geometric styling, decisive silhouettes, energetic editorial composition",
